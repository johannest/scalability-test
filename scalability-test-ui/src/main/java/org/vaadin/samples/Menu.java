...
public class Menu extends CssLayout {
    ...
    public Menu(Navigator navigator) {
        ...
        logoutMenu.setId("myui-menu-logoutmenu");
        ...
        showMenu.setId("myui-menu-showmenu");

        // container for the navigation buttons, which are added by addView()
        menuItemsLayout = new CssLayout();
        menuItemsLayout.setPrimaryStyleName(VALO_MENUITEMS);
        menuPart.addComponent(menuItemsLayout);
        menuItemsLayout.setId("myui-menu-menuitesmslayout");
    ...
    private void createViewButton(final String name, String caption,
        ...
        button.setId("myui-menu-"+caption);
    }
