package org.vaadin.samples.crud;

import java.util.Collection;

import org.vaadin.samples.backend.DataService;
import org.vaadin.samples.backend.data.Availability;
import org.vaadin.samples.backend.data.Category;
import org.vaadin.samples.backend.data.Product;
...
public class ProductForm extends ProductFormDesign {
    ...
    public ProductForm(SampleCrudLogic sampleCrudLogic) {
        ...
        for (Field f : fieldGroup.getFields()) {
            ...
            f.setId("myui-form-field-"+f.getCaption());
        }
