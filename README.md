...
- scalability-test-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- scalability-test-ui: main application module, development time
- scalability-test-production: module that produces a production mode WAR for deployment
